...
#>
<<<<<<< HEAD:Template/CustomInv-Template-Win10.ps1

$VerbosePreference = 'SilentlyContinue'
=======
>>>>>>> parent of 23a9230 (Update and rename CustomInv-Template.ps1 to CustomInv-Template-Win10.ps1):Template/CustomInv-Template.ps1
